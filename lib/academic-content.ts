...
export const researchThemes = [
  ...
  {
    title: "Physics-Informed Computational Methods",
    problem:
      "Purely data-driven models can become unreliable when photonic data are sparse, expensive to generate, or tied to boundary conditions and conservation laws.",
    methods:
      "Physics-informed neural networks, surrogate modeling, residual-based loss terms, solver-to-model validation, and constrained optimization workflows.",
    physicalRelevance:
      "These methods are useful when they preserve Maxwell, transport, and boundary-condition structure rather than replacing physical reasoning with black-box fitting.",
  },
  {
    title: "Inverse Design for Photonic Systems",
    problem:
      "Many useful photonic responses are easier to specify as target spectra, fields, efficiencies, or bandwidths than to derive manually from geometry.",
    methods:
      "Parametric sweeps, gradient-based optimization, adjoint-inspired reasoning, electromagnetic simulation, and post-processing pipelines for design comparison.",
    physicalRelevance:
      "Inverse design reframes photonic design as a constrained physics problem, but the resulting structures still need interpretable checks against loss, sensitivity, and fabrication tolerance.",
  },
